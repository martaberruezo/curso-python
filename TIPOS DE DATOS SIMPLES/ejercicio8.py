...
#entre <m> da un cociente <c> y un resto <r> donde <n> y <m> son los números introducidos por el
#usuario, y <c> y <r> son el cociente y el resto de la división entera respectivamente.


n = input("introduzca numero dividendo (entero): ")
m = input("introduzca numero divisor (entero): ")
